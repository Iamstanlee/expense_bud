...
class ExpenseProvider with ChangeNotifier {
  ...
  double _getTotal(List<ExpenseEntity>? entries) {
  ...
  double getMonthTotal() =>
      _monthEntries.data?.values.fold<double>(
        0,
