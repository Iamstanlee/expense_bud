...
// TODO: use streams for entries
abstract class IExpenseLocalDataSource {
  Future<List<ExpenseModel>> getDailyEntries();
  Future<Map<String, List<ExpenseModel>>> getMonthlyEntries();
...
class ExpenseLocalDataSource implements IExpenseLocalDataSource {
  ...
  @override
  Future<Map<String, List<ExpenseModel>>> getMonthlyEntries() async {
    try {
  ...
  @override
  Future<List<ExpenseModel>> getDailyEntries() async {
    try {
      final today = DateTime.now().toIso8601String();
